...
ADMINS = (
    ('Jean Bauer', 'jabauer@uchicago.edu'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'eafsd',                      # Or path to database file if using sqlite3.
...
f = os.path.join(BASE_DIR, "ProjectQuincy", "local_settings.py")
if os.path.exists(f):
    import sys
    import imp
    module_name = "ProjectQuincy.local_settings"
